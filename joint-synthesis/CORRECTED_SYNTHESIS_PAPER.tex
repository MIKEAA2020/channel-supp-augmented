...
\]
with $\mathcal I_*$ an optimal centre and the diameter of the body exactly $2$; the same value is also the \emph{global} in-radius: no other centre of the body carries a larger relative ball. The replacement body has exact antipodal profile
\[
